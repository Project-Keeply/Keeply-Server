...
> 이 스킬은 표준 Flight Protocol의 **Flight** 단계입니다. 실행 전 [Preflight](../../checklists/preflight.md), 실행 후 [Postflight](../../checklists/postflight.md) → [Debrief](../../checklists/debrief.md)를 따르세요. (본 스킬은 코드 변경이 없으므로 Postflight의 Gradle 검증은 N/A로 처리)
